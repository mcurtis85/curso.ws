...
import br.com.caelum.estoque.soap.AutorizacaoException;
...
public class Carrinho implements Serializable {
	...
	public void atualizarFrete(final String novoCepDestino) throws RemoteException, ServiceException {
	...
	public void verificarDisponibilidadeDosItensComSoap() throws AutorizacaoException {
...
//		for (ItemCompra itemCompra : this.itensDeCompra) {
//			if (itemCompra.isImpresso()) {
//				System.out.println("Verificaçao da Quantidade do Livro: " +itemCompra.getTitulo());
//				
