...
public class ConsumidorServicoCorreios {
	...
	public BigDecimal calculaFrete(String cepDestino) throws ServiceException, RemoteException {

		CalcPrecoPrazoWSSoap servico = new CalcPrecoPrazoWSLocator().getCalcPrecoPrazoWSSoap();

		cepDestino = this.tirarHifenDoCep(cepDestino);
		String valorFrete = null;
		System.out.println("Servico Correios");
		...
		CServico[] servicosPesquisados = resultado.getServicos();
		
		valorFrete = servicosPesquisados[0].getValor();
