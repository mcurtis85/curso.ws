...
public class CalcPrecoPrazoWSLocator extends org.apache.axis.client.Service implements br.com.caelum.correios.soap.CalcPrecoPrazoWS {
    ...
    public br.com.caelum.correios.soap.CalcPrecoPrazoWSSoap getCalcPrecoPrazoWSSoap() throws javax.xml.rpc.ServiceException {
    ...
    public br.com.caelum.correios.soap.CalcPrecoPrazoWSSoap getCalcPrecoPrazoWSSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.caelum.correios.soap.CalcPrecoPrazoWSSoapStub _stub = new br.com.caelum.correios.soap.CalcPrecoPrazoWSSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.com.caelum.correios.soap.CalcPrecoPrazoWSSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.caelum.correios.soap.CalcPrecoPrazoWSSoapStub _stub = new br.com.caelum.correios.soap.CalcPrecoPrazoWSSoapStub(new java.net.URL(CalcPrecoPrazoWSSoap_address), this);
                _stub.setPortName(getCalcPrecoPrazoWSSoapWSDDServiceName());
                return _stub;
            }
        }
