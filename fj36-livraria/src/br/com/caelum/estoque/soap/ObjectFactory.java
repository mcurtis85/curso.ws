...
public class ObjectFactory {
    ...
    private final static QName _AddItemEstoque_QNAME = new QName("http://caelum.com.br/estoquews/v1", "addItemEstoque");
    private final static QName _ItensPeloCodigo_QNAME = new QName("http://caelum.com.br/estoquews/v1", "ItensPeloCodigo");
    private final static QName _AddItemEstoqueResponse_QNAME = new QName("http://caelum.com.br/estoquews/v1", "addItemEstoqueResponse");
    private final static QName _AutorizacaoFault_QNAME = new QName("http://caelum.com.br/estoquews/v1", "AutorizacaoFault");
    ...
    /**
     * Create an instance of {@link AutorizacaoFault }
     * 
     */
    public AutorizacaoFault createAutorizacaoFault() {
        return new AutorizacaoFault();
    }

    /**
     * Create an instance of {@link AddItemEstoqueResponse }
     * 
     */
    public AddItemEstoqueResponse createAddItemEstoqueResponse() {
        return new AddItemEstoqueResponse();
    }
    ...
    /**
     * Create an instance of {@link AddItemEstoque }
     * 
     */
    public AddItemEstoque createAddItemEstoque() {
        return new AddItemEstoque();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link AddItemEstoque }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://caelum.com.br/estoquews/v1", name = "addItemEstoque")
    public JAXBElement<AddItemEstoque> createAddItemEstoque(AddItemEstoque value) {
        return new JAXBElement<AddItemEstoque>(_AddItemEstoque_QNAME, AddItemEstoque.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link AddItemEstoqueResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://caelum.com.br/estoquews/v1", name = "addItemEstoqueResponse")
    public JAXBElement<AddItemEstoqueResponse> createAddItemEstoqueResponse(AddItemEstoqueResponse value) {
        return new JAXBElement<AddItemEstoqueResponse>(_AddItemEstoqueResponse_QNAME, AddItemEstoqueResponse.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link AutorizacaoFault }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://caelum.com.br/estoquews/v1", name = "AutorizacaoFault")
    public JAXBElement<AutorizacaoFault> createAutorizacaoFault(AutorizacaoFault value) {
        return new JAXBElement<AutorizacaoFault>(_AutorizacaoFault_QNAME, AutorizacaoFault.class, null, value);
    }
